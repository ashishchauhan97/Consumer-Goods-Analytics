...
round(avg(i.pre_invoice_discount_pct)*100,2)as avg_dis_pct from fact_pre_invoice_deductions i
join dim_customer c 
using (customer_code)
...
round(sum(g.gross_price*sold_quantity),2) as gross_sales_amt from fact_sales_monthly s
